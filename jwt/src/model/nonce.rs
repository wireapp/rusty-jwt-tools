...
pub struct AcmeNonce(pub String);

impl From<String> for AcmeNonce {
    fn from(challenge: String) -> Self {
        Self(challenge)
    }
}

impl From<&str> for AcmeNonce {
    fn from(challenge: &str) -> Self {
        challenge.to_string().into()
    }
}

impl TryFrom<&[u8]> for AcmeNonce {
...
impl std::ops::Deref for AcmeNonce {
    type Target = String;
...
impl AcmeNonce {
    pub fn rand() -> Self {
        Self(crate::test_utils::rand_base64_str(32))
    }
}

#[cfg(test)]
impl Default for AcmeNonce {
    fn default() -> Self {
